...
const ELEMENT_DATA: PeriodicElement[] = [
    {
        ...
        clientName: {
            img: 'main/webapp/assets/img/user/user12.jpg',
    ...
    },
    {
        ...
        clientName: {
            img: 'main/webapp/assets/img/user/user13.jpg',
            name: 'Lydia Reese',
            username: '@lydiareese'
        },
        total: '$400',
    ...
    },
    {
        ...
        clientName: {
            img: 'main/webapp/assets/img/user/user14.jpg',
            name: 'James Andy',
            username: '@jamesandy'
        },
        total: '$321',
    ...
    },
    {
        ...
        clientName: {
            img: 'main/webapp/assets/img/user/user11.jpg',
            name: 'Louis Brandon',
    ...
    },
    {
        ...
        clientName: {
            img: 'main/webapp/assets/img/user/user9.jpg',
            name: 'Larry Nielsen',
    ...
    {
        id: '#14251',
        invoiceName: 'Atmos UI',
        issuedDate: '03 Apr 2023',
        clientName: {
            img: 'main/webapp/assets/img/user/user24.jpg',
            name: 'Stanley Bland',
    ...
    },
    {
        ...
        issuedDate: '12 Feb 2023',
        clientName: {
            img: 'main/webapp/assets/img/user/user23.jpg',
            name: 'Mark Evans',
            username: '@markevans'
        },
        total: '$128',
    ...
    },
    {
        ...
        issuedDate: '14 Mar 2023',
        clientName: {
            img: 'main/webapp/assets/img/user/user15.jpg',
            name: 'Timothy Lee',
            username: '@timothylee'
        },
        total: '$199',
    ...
    },
    {
        ...
        clientName: {
            img: 'main/webapp/assets/img/user/user1.jpg',
    ...
    },
    {
        ...
        issuedDate: '10 Mar 2023',
        clientName: {
            img: 'main/webapp/assets/img/user/user2.jpg',
    ...
    },
    {
        ...
        issuedDate: '08 Mar 2023',
        clientName: {
            img: 'main/webapp/assets/img/user/user3.jpg',
            name: 'Candice Munoz',
    ...
    },
    {
        ...
        issuedDate: '28 Feb 2023',
        clientName: {
            img: 'main/webapp/assets/img/user/user4.jpg',
    ...
    },
    {
        ...
        issuedDate: '03 Apr 2023',
        clientName: {
            img: 'main/webapp/assets/img/user/user5.jpg',
            name: 'Kristie Hall',
    ...
    },
    {
        ...
        issuedDate: '01 Mar 2023',
        clientName: {
            img: 'main/webapp/assets/img/user/user6.jpg',
            name: 'Bolton Obrien',
