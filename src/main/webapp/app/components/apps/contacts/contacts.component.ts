...
const ELEMENT_DATA: PeriodicElement[] = [
    {
        ...
        image: 'main/webapp/assets/img/user/user22.jpg',
    ...
    },
    {
        ...
        image: 'main/webapp/assets/img/user/user21.jpg',
    ...
    {
        name: 'Candice Munoz',
        image: 'main/webapp/assets/img/user/user20.jpg',
    ...
    },
    {
        ...
        image: 'main/webapp/assets/img/user/user19.jpg',
    ...
    {
        name: 'Kristie Hall',
        image: 'main/webapp/assets/img/user/user15.jpg',
    ...
    {
        name: 'Bolton Obrien',
        image: 'main/webapp/assets/img/user/user14.jpg',
    ...
    {
        name: 'Dee Alvarado',
        image: 'main/webapp/assets/img/user/user13.jpg',
    ...
    },
    {
        ...
        image: 'main/webapp/assets/img/user/user11.jpg',
    ...
    },
    {
        ...
        image: 'main/webapp/assets/img/user/user9.jpg',
    ...
    {
        name: 'Alissa Nelson',
        image: 'main/webapp/assets/img/user/user8.jpg',
    ...
    {
        name: 'English Haney',
        image: 'main/webapp/assets/img/user/user7.jpg',
    ...
    },
    {
        ...
        image: 'main/webapp/assets/img/user/user6.jpg',
    ...
    {
        name: 'Lucile Young',
        image: 'main/webapp/assets/img/user/user5.jpg',
    ...
    },
    {
        ...
        image: 'main/webapp/assets/img/user/user4.jpg',
    ...
    {
        name: 'Francis Frank',
        image: 'main/webapp/assets/img/user/user3.jpg',
    ...
    },
    {
        ...
        image: 'main/webapp/assets/img/user/user2.jpg',
    ...
    {
        name: 'James Andy',
        image: 'main/webapp/assets/img/user/user1.jpg',
